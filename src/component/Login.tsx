...
function Login({ openSignUp }: any) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(
        "http://192.168.12.206:5000/chat/user/login",
        value
      );
  ...
  return (
    <div className="mx-auto w-full max-w-md space-y-4 rounded-lg border p-7 shadow-lg sm:p-10 bg-sky-900 text-white">
